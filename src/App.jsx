                        ...
                        <td className="text-center">
                          <div className="form-check form-switch d-inline-block">
                            <input
                              ...
                              onChange={() => toggleDomaine(c.id, c.domaine)}

                            />
                            <div className={`fw-bold small mt-1 ${c.domaine ? 'text-success' : 'text-danger'}`}>
                        ...
                        <td className="text-center">
                          <div className="form-check form-switch d-inline-block">
                            <input
                              ...
                              onChange={() => toggleWifi(c.id, c.wifi)}

                            />
                            <div className={`fw-bold small mt-1 ${c.wifi ? 'text-success' : 'text-danger'}`}>
              ...
              <div className="modal-body p-4 bg-white">
                <div className="row g-4">
                  ...
                  <div className="col-12">
                    <div className="p-3 rounded-4 bg-light d-flex justify-content-between align-items-center border border-2 border-dashed">
                      <div>
                        <p className="mb-0 fw-bold">État du domaine</p>
                        <small className="text-muted">Cochez si le domaine de l'appareil est le bon</small>
                      </div>
                      <div className="form-check form-switch m-0">
                  ...
                  <div className="col-12">
                    <div className="p-3 rounded-4 bg-light d-flex justify-content-between align-items-center border border-2 border-dashed">
                      <div>
                        <p className="mb-0 fw-bold">État du wifi</p>
                        <small className="text-muted">Cochez si l'appareil peut accéder au wifi</small>
                      </div>
                      <div className="form-check form-switch m-0">
